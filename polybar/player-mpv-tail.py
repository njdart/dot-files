#!/usr/bin/env python3
#
# This is a copy of player-mpv-tail.py from the "polybar-scripts" repository:
# https://github.com/polybar/polybar-scripts/tree/master/polybar-scripts/player-mpv-tail
#
